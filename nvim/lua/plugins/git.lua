return {
  ...
  { -- Great Git diff viewer
    ...
    config = function()
      -- Diff views
      vim.keymap.set("n", "<leader>gd", ":DiffviewOpen<CR>", { desc = "Open Project Diffs for Current Index" })
      vim.keymap.set("n", "<leader>gD", ":DiffviewClose<CR>", { desc = "Close Project Diffs" })

      -- Diff toggles
      vim.keymap.set("n", "<leader>gh", ":DiffviewFileHistory<CR>", { desc = "Browse Project Commit History" })
      vim.keymap.set("n", "<leader>gH", ":DiffviewFileHistory %<CR>", { desc = "Current File Commit History" })
    end,
  },
